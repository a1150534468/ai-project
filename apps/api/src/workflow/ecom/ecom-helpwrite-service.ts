...
import { createUnmeteredImageUsage as makeUnmeteredImageUsage } from "../_shared/unmetered-image-usage.js";
...
type BillingReserveSettle = Pick<ReturnType<typeof makeUnmeteredImageUsage>, "reserve" | "settle">;
type LlmClientLike = {
  readonly messages: {
...
function defaultBilling(): BillingReserveSettle {
  return makeUnmeteredImageUsage();
}
