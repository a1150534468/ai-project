  ...
  return (
    <div className="relative min-w-0 flex-1">
      ...
      <button
        ...
        aria-expanded={open}
      >
        <Icon icon={icon} className="flex-none text-lg text-[#6e6e73]" aria-hidden />
      ...
      {open && (
        <div className="absolute left-0 right-0 top-[calc(100%+8px)] z-30 overflow-hidden rounded-[12px] border border-[#e8e8ed] bg-white shadow-[0_18px_40px_rgba(15,23,42,0.12)]">
          <div className="border-b border-[#f0f0f3] px-3 py-2 text-[11px] font-semibold uppercase tracking-[0.06em] text-[#6e6e73]">
            {label}
          </div>
