...
function Empty({ children }: { readonly children: string }) {
  return <div className="grid min-h-40 place-items-center rounded-xl border border-dashed border-[#d9dfdd] px-4 text-center text-xs leading-5 text-ink-tertiary">{children}</div>;
}
