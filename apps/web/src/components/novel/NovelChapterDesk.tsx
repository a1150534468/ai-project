...
type DeskTab = "prose" | "plan" | "beats" | "prompts" | "compare" | "versions";
    ...
    <section className="flex min-h-0 min-w-0 flex-col bg-white">
      <header className="flex-none border-b border-[#e3e8e6] px-4 py-3 sm:px-5">
        ...
        <nav className="mt-3 flex gap-1 overflow-x-auto [scrollbar-width:none]">{([
          ["prose", "章节正文", "mdi:file-document-edit-outline"], ["plan", "执行剧本", "mdi:clipboard-text-outline"], ["beats", "微节拍", "mdi:metronome"], ["prompts", "提示词记录", "mdi:message-text-lock-outline"], ["compare", "原稿对比", "mdi:file-compare-outline"], ["versions", "版本历史", "mdi:history"],
