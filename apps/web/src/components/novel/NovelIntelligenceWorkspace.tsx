...
function ActionButtons({ onEdit, onDelete }: { onEdit: () => void; onDelete: () => void }) {
  return <div className="flex gap-1 opacity-100"><button type="button" onClick={onEdit} className="grid h-7 w-7 place-items-center rounded-lg text-ink-secondary" aria-label="编辑"><Icon icon="mdi:pencil-outline" /></button><button type="button" onClick={onDelete} className="grid h-7 w-7 place-items-center rounded-lg text-[#8a8f8d]" aria-label="删除"><Icon icon="mdi:trash-can-outline" /></button></div>;
}
