...
export function NovelRunCockpit({
  ...
  return (
    <section className="grid min-w-0 gap-4">
      ...
      {view === "governance" && <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">{[
