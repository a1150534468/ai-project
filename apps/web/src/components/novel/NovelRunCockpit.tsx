      ...
      <div className="flex-none rounded-[14px] border border-hairline-subtle bg-white p-4 shadow-[0_16px_44px_rgba(15,23,42,0.055)] sm:p-5">
        ...
        {view === "cockpit" && <><div className="mt-5 grid gap-3 sm:grid-cols-2 xl:grid-cols-5">
          {[
            ...
            <div key={label} className="rounded-xl border border-hairline-subtle bg-[#f7faf9] p-3">
