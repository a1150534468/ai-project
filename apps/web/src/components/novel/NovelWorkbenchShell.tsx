...
export function NovelWorkbenchShell({
  ...
  return (
    <section className="flex h-full min-h-0 flex-col overflow-hidden bg-surface-muted text-ink">
      <header className="flex-none border-b border-hairline-subtle bg-surface">
