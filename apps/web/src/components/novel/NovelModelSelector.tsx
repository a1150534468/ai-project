...
export function NovelModelSelector({
  ...
  return (
    <label className="flex h-9 shrink-0 items-center gap-1.5 rounded-lg border border-hairline bg-[#fafbfb] px-2.5 text-[10px] font-semibold text-ink-tertiary transition focus-within:border-brand/60 focus-within:ring-2 focus-within:ring-brand/10" title={title}>
