    ...
    <div className="grid gap-5 px-5 py-5 sm:px-6">
      <div className="grid gap-2">
        ...
        <textarea
          ...
          rows={14}
          className="min-h-[320px] w-full resize-none whitespace-pre-wrap rounded-lg border border-[#d2d2d7] bg-[#f7f8fa] px-4 py-3 text-sm leading-7 text-ink outline-none transition focus:border-brand focus:bg-white"
      ...
      <div className="grid gap-2">
        ...
        <input
          ...
          className="w-full rounded-lg border border-[#d2d2d7] bg-[#f7f8fa] px-4 py-3 text-sm leading-6 text-ink outline-none transition focus:border-brand focus:bg-white"
