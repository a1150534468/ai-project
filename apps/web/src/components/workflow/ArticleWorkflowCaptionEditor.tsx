    ...
    <div className="grid gap-5 px-5 py-5 sm:px-6">
      <div className="grid gap-2">
        <div className="flex items-center justify-between gap-3">
          <label htmlFor="article-caption-text" className="text-sm font-semibold text-[#1d1d1f]">正文文案</label>
        ...
        <textarea
          ...
          rows={14}
          className="min-h-[320px] w-full resize-none whitespace-pre-wrap rounded-lg border border-[#d2d2d7] bg-[#f7f8fa] px-4 py-3 text-sm leading-7 text-[#1d1d1f] outline-none transition focus:border-brand focus:bg-white"
      ...
      <div className="grid gap-2">
        <div className="flex items-center justify-between gap-3">
          <label htmlFor="article-caption-tags" className="text-sm font-semibold text-[#1d1d1f]">标签</label>
        ...
        <input
          ...
          className="w-full rounded-lg border border-[#d2d2d7] bg-[#f7f8fa] px-4 py-3 text-sm leading-6 text-[#1d1d1f] outline-none transition focus:border-brand focus:bg-white"
