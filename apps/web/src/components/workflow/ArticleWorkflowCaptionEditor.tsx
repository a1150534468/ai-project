    ...
    <div className="grid gap-5 px-5 py-5 sm:px-6">
      <div className="grid gap-2">
        <div className="flex items-center justify-between gap-3">
          ...
          <span className={`text-xs ${captionOver ? "font-semibold text-danger-ink" : "text-ink-tertiary"}`}>
        ...
        <textarea
          ...
          rows={14}
          className="min-h-[320px] w-full resize-none whitespace-pre-wrap rounded-lg border border-hairline bg-surface-subtle px-4 py-3 text-sm leading-7 text-ink outline-none transition focus:border-brand focus:bg-surface"
      ...
      <div className="grid gap-2">
        <div className="flex items-center justify-between gap-3">
          ...
          <span className={`text-xs ${tagsOver || tagsShort ? "font-semibold text-danger-ink" : "text-ink-tertiary"}`}>
        ...
        <input
          ...
          className="w-full rounded-lg border border-hairline bg-surface-subtle px-4 py-3 text-sm leading-6 text-ink outline-none transition focus:border-brand focus:bg-surface"
