...
export const MEMORY_TYPE_STYLES: Readonly<Record<MemoryType, MemoryTypeStyle>> = {
  CORE: {
    ...
    filterInactive: "border-surface/70 bg-surface/75 text-amber-700/80 ",
    editorActive: "border-amber-300 bg-amber-50 text-amber-700",
    editorIdle: "border-hairline bg-surface text-ink-secondary ",
  ...
  PERMANENT: {
    ...
    filterInactive: "border-surface/70 bg-surface/75 text-sky-700/80 ",
  ...
  TEMPORARY: {
    ...
    filterInactive: "border-surface/70 bg-surface/75 text-brand-ink/80 ",
  ...
  KNOWLEDGE: {
    ...
    filterInactive: "border-surface/70 bg-surface/75 text-violet-700/80 ",
  ...
  OTHER: {
    ...
    filterInactive: "border-surface/70 bg-surface/75 text-slate-600 ",
