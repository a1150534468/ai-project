          ...
          {selectedNode ? (
            <>
              ...
              <motion.div
                ...
                exit="exit"
              >
                <div className="flex max-h-[82vh] min-h-0 flex-col rounded-t-[20px] border border-b-0 border-hairline bg-surface px-3 pb-3 pt-2 shadow-[0_-14px_36px_rgba(15,23,42,0.12)]">
